...
import { createEditToolDefinition, getLanguageFromPath, keyHint } from "@mariozechner/pi-coding-agent";
...
export function registerEdit(pi: ExtensionAPI, cwd: string) {
	...
	pi.registerTool({
		...
		renderCall(args, theme, context) {
			...
			const previewKey = previewCacheKey("edit-call", operationsSource, path, context.expanded, theme);
